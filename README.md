...
repeat Cafe visits after cooldown, finish live invitation validation, then add another job. configured mission sweeps are a useful next step: collecting Cafe AP clears its storage, but spending it needs its own policy. lesson, social, crafting, and event farming follow one verified routine at a time.
